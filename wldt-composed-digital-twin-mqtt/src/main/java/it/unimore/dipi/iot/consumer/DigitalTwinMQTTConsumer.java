 ...
 */
public class DigitalTwinMQTTConsumer {

    private final static Logger logger = LoggerFactory.getLogger(DigitalTwinMQTTConsumer.class);
    ...
    private static final String TARGET_TOPIC = "device/average";
